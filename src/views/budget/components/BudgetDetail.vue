  ...
  <el-card class="form-container" shadow="never">
    <el-form :model="budget" :rules="rules" ref="budgetFrom" label-width="150px">
      <el-form-item label="交易日期：" prop="tradeData">
        <el-date-picker type="date" placeholder="选择日期" v-model="budget.tradeData" style="width: 100%;"></el-date-picker>
      </el-form-item>
      <el-form-item label="店名：" prop="storeName">
        <el-input v-model="budget.storeName"></el-input>
      </el-form-item>
      <el-form-item label="类型：" prop="type">
        <el-input v-model="budget.type"></el-input>
      </el-form-item>
      <el-form-item label="金额相关备注：" prop="amountRemark">
        <el-input v-model="budget.amountRemark"></el-input>
      </el-form-item>
      <el-form-item label="支出金额：" prop="pay">
        <el-input v-model="budget.pay"></el-input>
      </el-form-item>
      <el-form-item label="收入金额：" prop="income">
        <el-input v-model="budget.income"></el-input>
      </el-form-item>
      <el-form-item label="支出方名称：" prop="payName">
        <el-input v-model="budget.payName"></el-input>
      </el-form-item>
      <el-form-item label="支出方备注：" prop="payRemark">
        <el-input v-model="budget.payRemark"></el-input>
      </el-form-item>
      <el-form-item label="支出方账户：" prop="payAccount">
        <el-input v-model="budget.payAccount"></el-input>
      </el-form-item>
      <el-form-item label="收入方名称：" prop="incomeName">
        <el-input v-model="budget.incomeName"></el-input>
      </el-form-item>
      <el-form-item label="收入方账户：" prop="incomeAccount">
        <el-input v-model="budget.incomeAccount"></el-input>
      </el-form-item>
      <el-form-item label="收入方备注：" prop="incomeRemark">
        <el-input v-model="budget.incomeRemark"></el-input>
      </el-form-item>
      <el-form-item label="备注：" prop="remark">
        <el-input v-model="budget.remark"></el-input>
      </el-form-item>
      <el-form-item label="核对人：" prop="checkName">
        <el-input v-model="budget.checkName"></el-input>
      </el-form-item>
      <el-form-item>
